      ...
      <List>
        ...
        <Collapse in={openServices} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            <ListItemButton sx={{ justifyContent: 'center', textAlign: 'center', width: '100%' }}>
      ...
      <div className="nav-cont">
        ...
        <button className="nav-title" onClick={toggleServicesDropdown}>
          <span style={{ display: "flex", alignItems: "flex-end" }}>
            Services
            {showServicesDropdown ? <KeyboardArrowUpIcon sx={{ paddingLeft: "2px" }} /> : <KeyboardArrowDownIcon sx={{ paddingLeft: "2px" }} /> }
          </span>
        </button>
        ...
        <button className="nav-title" onClick={toggleInsightsDropdown}>
          <span style={{ display: "flex", alignItems: "flex-end" }}>
            Insights
            {showInsightsDropdown ? <KeyboardArrowUpIcon sx={{ paddingLeft: "2px" }} /> : <KeyboardArrowDownIcon sx={{ paddingLeft: "2px" }} /> }
          </span>
        </button>
